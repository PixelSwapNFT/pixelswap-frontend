...
import { Card, CardBody, Heading, Text } from 'pixelswap-uikit'
...
const Mint: React.FC = () => {
  ...
  return (
    <>
      ...
      <Text as="p" mb="24px">
        {TranslateString(790, 'You can change your profile pic later if you get another approved Pixel Collectible.')}
      </Text>
      <Card mb="24px">
        <CardBody>
