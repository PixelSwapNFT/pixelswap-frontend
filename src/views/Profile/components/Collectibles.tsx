...
import { Heading, Text, Flex, ChevronRightIcon } from 'pixelswap-uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'Pixel Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'Pixel Collectibles are special ERC-721 NFTs that can be used on the PixelSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved Pixel Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved Pixel Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
